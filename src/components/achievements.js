		...
		<div className="container-fluid achievements-container-fluid">
			...
			<h3 className="text-white text-center p-4">Achievements & Extra Activity</h3>
				<div className="row">
					...
					<ul>
						<li><i className="fa fa-trophy"></i> Won <b>First Prize</b> in <b>Chess</b>competetion in college techfest "<b>Emblaze 2K16.</b>"</li>
						<li>Actively Participate in <b>Chess</b> during college sports. </li>
						<li><i className="fa fa-trophy"></i><b>Secured second position</b> in <b>"general knowledge examination"</b> held in <b>SLS college</b> Shujalpur in the year 2013.</li>
						
						<li>Two times runner up in chess during college nodals.</li>
					...
					<div className="col-md-4">
						<span className="text-white text-center">Wordpress Apporved Plugin</span>
